        ...
        messages: [
          {
            role: "system",
            content:
              "You are a helpful assistant. Make sure you always output a list of tuples that can be easily processed.",
          },
          {
            role: "user",
            content: [
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a helpful assistant. Make sure you ONLY output a list of tuples that can be easily processed.",
        },
        {
          role: "user",
          content: [
